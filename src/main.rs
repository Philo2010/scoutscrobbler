...
async fn rocket() -> _ {
   ...
   let client = Client::builder()
    ...
    .mount("/", routes![submit::submit_page, user::new_user, login::login, search::search, get_player_match::get_player_match, graph::graph, queue::queue_form, scout::scout, submit_bad::submit_page, remove_queue::queue_remove, pit::pit_submit, view_all_entries::get_entries, team_avarages::avarage_team, viewpit::view_pit, team_avarages::avarage_team_event, pit::pit_auto_submit])
